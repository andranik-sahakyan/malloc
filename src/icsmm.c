...
void* ics_malloc(size_t size) { 
	...
	while (found_block == NULL) {
		...
		if ((prev_size & 1) == 0) { 
			...
			new_block->header.block_size += PSIZE;
			new_block->header.unused = HEADER_UNUSED;
			uint64_t new_block_size = new_block->header.block_size;
			...
			((ics_header*)(((char*)(new_block)) + new_block_size))->requested_size = 0;
			...
			new_block->header.block_size = PSIZE;
			new_block->header.unused = HEADER_UNUSED;
			((ics_footer*)(((char*)(new_block)) + PSIZE - WSIZE))->block_size = PSIZE;
			((ics_footer*)(((char*)(new_block)) + PSIZE - WSIZE))->unused = FOOTER_UNUSED;
		
			((ics_header*)(((char*)(new_block)) + PSIZE))->requested_size = 0;
			((ics_header*)(((char*)(new_block)) + PSIZE))->block_size = 1;
		}
